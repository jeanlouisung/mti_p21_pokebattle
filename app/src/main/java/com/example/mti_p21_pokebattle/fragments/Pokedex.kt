...
//        super.onViewCreated(view, savedInstanceState)
        val data: MutableList<PokemonDetail> = arrayListOf()
        ...
        val wsCallback: Callback<List<PokemonDetail>> = object : Callback<List<PokemonDetail>> {
            override fun onFailure(call: Call<List<PokemonDetail>>, t: Throwable) {
            ...
            override fun onResponse(
                call: Call<List<PokemonDetail>>,
                response: Response<List<PokemonDetail>>
            ) {
...
//                        for (pokemon in responseData) {
//                            Log.d("Pokemons list", pokemon.types[0].name)
//                        }
